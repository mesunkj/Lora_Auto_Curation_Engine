...
cells.append({
    ...
    "source": [
        ...
        "FACE_ID = 'person_a' # @param {type:\"string\"}\n",
        ...
        "\n",
        "INPUT_DIR = os.path.join(PROJECT_ROOT, INPUT_DIR_NAME, FACE_ID)\n",
        "OUTPUT_DIR = os.path.join(PROJECT_ROOT, OUTPUT_DIR_NAME, FACE_ID)\n",
        "\n",
...
cells.append({
    ...
    "source": [
        ...
        "    \n",
        "    choice = input('👉 起飛前置檢查完畢。是否確認以上環境無誤並繼續載入模型執行？ (Y/n): ')\n",
        "    if choice.strip().lower() == 'n':\n",
        "        raise RuntimeError('🛑 已取消執行，請修正問題後重新執行。')\n",
        "    \n",
        "    return {\n",
        "        'input_dir': INPUT_DIR,\n",
...
cells.append({
    ...
    "source": [
        ...
        "            all_tasks.append((f, os.path.join(r, f)))\n",
        "\n",
        "for filename, filepath in all_tasks:\n",
        "    \n",
